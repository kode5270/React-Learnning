...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path='/checkout' element={<CheckoutPage carts={carts} loadCartsData={loadCartsData}/>} />
      <Route path='/orders' element={ <OrdersPage carts={carts} loadCartsData={loadCartsData}/> } />
